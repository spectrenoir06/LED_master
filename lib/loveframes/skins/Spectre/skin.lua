...
-- multichoicerow
skin.controls.multichoicerow_body_hover_color       = {0.4, 0.4, 0.4, 1}

-- slider
skin.controls.slider_bar_outline_color              = {0.91, 0.91, 0.91, 1}

-- checkbox
skin.controls.checkbox_check_color                  = {0.4, 0.4, 0.4, 1}
