...
vec4 effect(vec4 color, Image tex, vec2 texture_coords, vec2 screen_coords)
{
	...
	freqs[0] = 0.0;//texture( iChannel1, vec2( 0.01, 0.25 ) ).x;
	freqs[1] = 0.0;//texture( iChannel1, vec2( 0.07, 0.25 ) ).x;
	freqs[2] = 0.0;//texture( iChannel1, vec2( 0.15, 0.25 ) ).x;
	freqs[3] = 0.0;//texture( iChannel1, vec2( 0.30, 0.25 ) ).x;
